#include "VoronovaLexer.h"
#include "VoronovaParser.h"
#include "VoronovaAst.h"
...
int main(int argc, char const* argv[])
{
	if (argc != 2) {
		...
		llvm::Module* module = new llvm::Module("VoronovaLambda", context);
...
llvm::Function* createLambdaFunction(llvm::Module* module, llvm::LLVMContext& context) {
	...
	llvm::Function* function = llvm::Function::Create(funcType, llvm::Function::ExternalLinkage, "VokhmyaninaLambda", module);
