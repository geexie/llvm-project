...
llvm::Value* PowExpr::gen(llvm::IRBuilder<>* builder, llvm::LLVMContext& context) const {
	...
	llvm::Value* result = builder->CreateBinaryIntrinsic(llvm::Intrinsic::pow, builder->CreateSIToFP(v1, llvm::Type::getDoubleTy(context)), builder->CreateSIToFP(v2, llvm::Type::getDoubleTy(context)), nullptr, "powtmp");
