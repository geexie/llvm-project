#include "BaturinaLexer.hpp"
#include "BaturinaParser.hpp"
#include "BaturinaAst.hpp"
...
int main(int argc, char const* argv[])
{
    if (argc != 2){
        ...
        llvm::Module *module = new llvm::Module("BaturinaLambda", context);
...
llvm::Function *createLambdaFunction( llvm::Module *module, llvm::LLVMContext &context) {
  ...
  llvm::Function *function = llvm::Function::Create(funcType, llvm::Function::ExternalLinkage, "BaturinaLambda", module);
