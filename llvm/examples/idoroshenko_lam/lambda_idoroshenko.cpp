//===--- examples/lambda/lambda.cpp - An example of smallest possible language -----===//
//
...
//
//===----------------------------------------------------------------------===//
// Language which accepts (λx. + x 2)4 => 6 function in polish notation
// Integer type
// + and * operators
//===----------------------------------------------------------------------===//

#include "ast_idoroshenko.hpp"
#include "lexer_idoroshenko.hpp"
#include "parser_idoroshenko.hpp"
