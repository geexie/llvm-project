#include "DVorobyovAst.hpp"
#include "DVorobyovLexer.hpp"
#include "DVorobyovParser.hpp"
...
int main(int argc, char const *argv[]) {
  if (argc != 2) {
    ...
    llvm::Module *module = new llvm::Module("DVorobyovLambda", context);
...
llvm::Function *createLambdaFunction(llvm::Module *module, llvm::LLVMContext &context) {
  ...
  llvm::Function *function = llvm::Function::Create(funcType, llvm::Function::ExternalLinkage, "DVorobyovLambda", module);
