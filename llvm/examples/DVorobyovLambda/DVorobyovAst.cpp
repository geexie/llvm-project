...
llvm::Value *PowExpr::gen(llvm::IRBuilder<> *builder, llvm::LLVMContext &context) const {
  llvm::Value *v1 = op1->gen(builder, context);
  llvm::Value *v2 = op2->gen(builder, context);
  auto a = builder->CreateSIToFP(v1, llvm::Type::getDoubleTy(context));
  auto b = builder->CreateSIToFP(v2, llvm::Type::getDoubleTy(context));
  llvm::Value *result = builder->CreateBinaryIntrinsic(llvm::Intrinsic::pow, a, b, nullptr, "powtmp");
