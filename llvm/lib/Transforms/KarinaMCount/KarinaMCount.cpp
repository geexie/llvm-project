...
#include "llvm/Transforms/KarinaMCount/KarinaMCount.h"

#define DEBUG_TYPE "karinam-count"
...
PreservedAnalyses KarinaMCountPass::run(Function &F, FunctionAnalysisManager &AM) {
