...
AnalysisKey OksanaKozlovaLoopAnalysis::Key;

OksanaKozlovaLoopAnalysis::Result OksanaKozlovaLoopAnalysis::run(Loop& L, LoopAnalysisManager& LAM, LoopStandardAnalysisResults& LSAR) {
    Result result;
