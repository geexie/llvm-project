...
AnalysisKey SazanovLoopAnalysis::Key;

SazanovLoopAnalysis::Result SazanovLoopAnalysis::run(Loop& L, LoopAnalysisManager& LAM, LoopStandardAnalysisResults& LSA)
{
	Result result;
